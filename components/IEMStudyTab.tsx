...
const IEMStudyTab: React.FC = () => {
    ...
    }, [simData, isRunning, centerFreq, spanMhz, refLevel, selectedRbw, showLabels, squelch, dimensions]);
        ...
        <div className="flex flex-col gap-6 relative">
            ...
            <Card className="!p-0 border-indigo-500/20 shadow-2xl overflow-hidden rounded-2xl">
                ...
                <div className="relative group">
                    <canvas ref={canvasRef} className="w-full h-[300px] md:h-[450px] bg-black" />
                </div>
            </Card>
