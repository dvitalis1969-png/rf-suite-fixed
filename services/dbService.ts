...
export const saveProject = (project: Omit<Project, 'id'> | Project): Promise<number | string> => {
  return new Promise((resolve, reject) => {
...
export const getProject = (id: number | string): Promise<Project> => {
    return new Promise((resolve, reject) => {
      const transaction = db.transaction([PROJECTS_STORE], 'readonly');
      const store = transaction.objectStore(PROJECTS_STORE);
...
export const deleteProject = (id: number | string): Promise<void> => {
  return new Promise((resolve, reject) => {
...
export const setLastProjectId = (id: number | string): Promise<void> => {
  return new Promise((resolve, reject) => {
...
export const getLastProjectId = (): Promise<number | string | null> => {
