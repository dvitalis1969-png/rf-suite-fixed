                                ...
                                {user?.email === 'dvitalis1969@gmail.com' && (
                                    <>
                                        ...
                                        <a 
                                            ...
                                            onClick={() => setIsProjectMenuOpen(false)}
                                            className="w-full flex items-center gap-4 p-3 rounded-xl bg-emerald-500/10 hover:bg-emerald-500/20 transition-all text-left group border border-emerald-500/20"
                                        >
                                            <div className="w-9 h-9 bg-emerald-900/30 border border-emerald-500/30 rounded-lg flex items-center justify-center text-lg group-hover:scale-110 transition-transform">🚀</div>
                                            <div>
